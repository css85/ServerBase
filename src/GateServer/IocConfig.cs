...
namespace GateServer
{
    public static class IocConfig
    {
        ...
        public static void AddAllServices(IServiceCollection services, IConfiguration config, IHostEnvironment env)
        {
            ...
            services.AddSingleton<GateAppContextService>();
            services.AddSingleton<AppContextServiceBase, GateAppContextService>(p => p.GetRequiredService<GateAppContextService>());


            services.AddChangeAbleSettings<GateAppSettings>(config, nameof(GateAppSettings));
            ...
            services.AddSingleton<GateCheckService>();
            services.AddHostedService<GateCheckService>();
        }
    }
}
