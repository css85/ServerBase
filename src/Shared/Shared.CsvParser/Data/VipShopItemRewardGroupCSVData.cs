...
{
    public class VipShopItemRewardGroupCSVData : BaseCSVData
    {
        public override string GetFileName() => "VIP_Shop_Item_RewardGroup.csv";
        ...
        public bool IsActiveShopProduct(int level) => ToVipLevel >= level;
