...
{
    public class AttendanceRewardGroupCSVData : BaseCSVData
    {
        public override string GetFileName() => "Attendance_RewardGroup.csv";
        ...
        [CSVColumn("day_order_num")]
        public int DayOrderNum { get; private set; }
