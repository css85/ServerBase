...
{
    public class RecommendCSVData : BaseCSVData
    {
        public override string GetFileName() => "Recommend.csv";

        [CSVColumn("index", primaryKey: true)]
        public long Index { get; private set; }

        [CSVColumn("recommend_num")]
        public int RecommendNum { get; private set; }
