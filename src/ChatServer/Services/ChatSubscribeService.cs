...
namespace ChatServer.Services
{
    ...
    {
        private readonly ILogger<ChatSubscribeService> _logger;
        ...
        public ChatSubscribeService(
            ILogger<ChatSubscribeService> logger,
        ...
        {
            _logger.LogInformation("ChatSubscribeService running.");
