...
{
    public class ChatAppContextService : AppContextServiceBase
    {
        private readonly ILogger<ChatAppContextService> _logger;
        ...
        public ChatAppContextService(
            ILogger<ChatAppContextService> logger,
            IHostEnvironment environment,
            IConfiguration configuration,
            ChangeableSettings<ChatAppSettings> appSettings
        ) : base(logger)
        {
            _logger = logger;
        ...
        {
            using (_logger.BeginScope("ChatAppContextService"))
            {
                _logger.LogInformation("----------------ChatAppContextService----------------");
