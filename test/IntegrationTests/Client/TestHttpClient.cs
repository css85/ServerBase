...
{
    public class TestHttpClient : ITestClient
    {
        ...
        public TestHttpClient(HttpClient httpClient, NetServiceType[] netServiceTypes)
        {
        ...
        public async Task<SendPacketResult> SendPacketInternalAsync(RequestReply reply,bool bAssert=false)
        {
            ...
            {
                response = Activator.CreateInstance(resType);
            }
